...
#ifndef SCHNAPPS_PLUGIN_CMAP_PROVIDER_UNDIRECTED_GRAPH_DOCK_TAB_H_
#define SCHNAPPS_PLUGIN_CMAP_PROVIDER_UNDIRECTED_GRAPH_DOCK_TAB_H_

#include <schnapps/plugins/cmap_provider/dll.h>

#include <schnapps/core/types.h>

#include <ui_undirected_graph_provider.h>
...
class SCHNAPPS_PLUGIN_CMAP_PROVIDER_API UndirectedGraphProvider_DockTab : public QWidget, public Ui::UndirectedGraphProvider_TabWidget
{
	Q_OBJECT

public:

	UndirectedGraphProvider_DockTab(SCHNApps* s, Plugin_CMapProvider* p);
	~UndirectedGraphProvider_DockTab() override;
...
private:
	...
	UndirectedGraphHandler* selected_map_;
...
public:
	...
	void add_map(UndirectedGraphHandler* ugh);
	void remove_map(UndirectedGraphHandler* ugh);
...
#endif // SCHNAPPS_PLUGIN_CMAP_PROVIDER_UNDIRECTED_GRAPH_DOCK_TAB_H_
